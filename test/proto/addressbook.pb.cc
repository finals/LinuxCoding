...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::addressbook::AddressBook, person_info_),
  ~0u,
};
...
void AddressBook::SerializeWithCachedSizes(
  ...
  // repeated .addressbook.Person person_info = 1;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->person_info_size()); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1,
      this->person_info(static_cast<int>(i)),
      output);
  }
...
::google::protobuf::uint8* AddressBook::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, this->person_info(static_cast<int>(i)), deterministic, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:addressbook.AddressBook)
  ...
  // repeated .addressbook.Person person_info = 1;
  {
    unsigned int count = static_cast<unsigned int>(this->person_info_size());
    total_size += 1UL * count;
    for (unsigned int i = 0; i < count; i++) {
      total_size +=
        ::google::protobuf::internal::WireFormatLite::MessageSize(
...
void AddressBook::InternalSwap(AddressBook* other) {
  using std::swap;
  CastToBase(&person_info_)->InternalSwap(CastToBase(&other->person_info_));
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
}
